...
import { Grid, TextField, Link, Snackbar, Alert } from "@mui/material";
...
const UndoPassword: React.FC<Props> = (props: any) => {
  ...
  const verifyIdentity = () => {
    ...
    if (validDateOfBirthForm()) {
      fetch(`/verify_date_of_birth/${props.patient_id}`, {
        method: "POST",
  ...
  const saveInfo = () => {
    ...
    if (validForm()) {
      ...
      setError("Invalid password, please check your entries and try again.");
      setDisabledButton(false);
    }
  };
        ...
        <Grid item xs={12}>
          ...
          >
            <Grid item xs={12} className={classes.pageTitle}>
              <span>Undo Password Change</span>
              <br />
              {!props.patient_id && <small>Invalid password token</small>}
            </Grid>
          </Grid>
          ...
          {props.patient_id && (
            <div className={classes.infoSection}>
              ...
              <p className={classes.modalTextSmall}>
                Password: <br />

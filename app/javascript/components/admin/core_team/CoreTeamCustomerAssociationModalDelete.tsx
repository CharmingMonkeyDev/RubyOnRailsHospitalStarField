...
const CoreTeamCustomerAssociationModalDelete: React.FC<Props> = (
  props: any
) => {
  const handleCustomerUserSave = () => {
    fetch(
      `/provider_customer_users/${props.deleteModalHandler.customerUserId}`,
      {
        method: "DELETE",
      ...
      <div className="paper">
        <div className="paperInner">
          <Grid container>
            ...
            <Grid item xs={12}>
              <p>
                Deactivating the provider from this customer association will no
                longer allow this provider to have access to the patient’s file.
...
export default CoreTeamCustomerAssociationModalDelete;

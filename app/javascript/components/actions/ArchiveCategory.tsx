...
const ArchiveCategory: React.FC<Props> = (props: Props) => {
  ...
  const ArchiveCategory = () => {
    if (props.selectedCatId) {
      fetch(`/action_categories/${props.selectedCatId}/archive`, {
        method: "Put",
  ...
  return (
    <>
      ...
      <ArchiveModal
        ...
        successContent={
          "You are attempting to archive this category. This cannot be undone. This will not affect published actions. Would you like to continue?"
        }
